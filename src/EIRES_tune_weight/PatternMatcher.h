...
//protected:
	...
	struct State
    {
        ...
        void setFutureUtilityMap(unordered_map<uint64_t, uint64_t> * _map) {m_lastTimeWindowFutureUtility = _map;}
        ...
        void setUuFuWeight(double w) {UuFuWeight = w;}
	...
	//private:
        ...
        unordered_map<uint64_t, uint64_t>*  m_lastTimeWindowFutureUtility;
