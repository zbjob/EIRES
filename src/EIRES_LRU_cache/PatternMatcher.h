...
public:
	...
	struct State
    {
        ...
        void setCache(LRUCache * _cache, int _num) {m_Cache = _cache; m_num_FetchWorker = _num;}
	...
	//private:
        ...
        static int noiseProbability;
        static int relaxProbability;
        static bool FLAG_greedy;
