...
do
    ...
    gzip -dc ../data/google_cluster_monitoring_datasets/sample_event_stream.dat.gz | ../src/EIRES_google_cluster_monitoring/bin/cep_match -c google_cluster.eql -q P7 -C 1 -L 2000  -u 20 -n google_cluster_BL3_"$j"_run -s -p throughput_google_cluster_BL3_"$j"_run.csv &
